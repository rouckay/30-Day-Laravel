                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-links href="/about" id="heloID"
                                    :active="request()->is('about')">about</x-nav-links>
                                <x-nav-links href="/contact" :active="request()->is('contact')">contact</x-nav-links>
                                <x-nav-links href="/jobs" :active="request()->is('jobs')">
                                    Jobs
                                </x-nav-links>
                            </div>
                        </div>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <!-- Profile dropdown -->
                            @guest
                                <x-nav-links href="/login" :active="request()->is('login')">Login</x-nav-links>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Farhad</div>
                            <div class="text-sm font-medium leading-none text-gray-400">farhad@expertrobot.pro</div>
                        </div>
                        <button type="button"
